				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div id="top-header" class="style2">
						...
						<div class="row">
							...
							<nav id="top-navigation" class="col-lg-12 col-md-12 col-sm-12">
								<ul class="pull-right">
									<li><a href="create_an_account.html">Mi Cuenta</a></li>
									<li><a href="orders_list.html">Lista de Compras</a></li>
									<li><a href="order_info.html">Revisa</a></li>
									<li><a href="text_page.html">Sobre Nosotros</a></li>
							...
							<nav id="middle-navigation" class="col-lg-8 col-md-8 col-sm-8">
								<ul class="pull-right">
									...
									<li class="login-create purple">
                                        ...
                                        <p>Bienvenido <a href="#">Inicia Sesión</a> o<br><a href="#">Crear una Cuenta</a></p>
										<ul id="login-dropdown" class="box-dropdown">
											<li>
												...
												<div class="footer">
													...
													<a class="button pull-right" href="crearCuenta.html">Crear una cuenta</a>
												</div>
											</li>
										</ul>
                                    </li>
					...
					<nav id="main-navigation" class="style2">
						<ul>
							...
							<li class="green">
								<a href="#">
									<span class="nav-caption">Verduras</span>
								...
								<ul class="wide-dropdown normalAniamtion">
									<li>
										<ul>
											...
											<li><a href="#"><i class="icons icon-right-dir"></i> Productos de Casa</a></li>
											<li><a href="#"><i class="icons icon-right-dir"></i> Productos de Temporada</a></li>
											<li><a href="#"><i class="icons icon-right-dir"></i> Próxima Cosecha</a></li>
											<li><a href="#"><i class="icons icon-right-dir"></i> Ofertas</a></li>
										</ul>
									</li>									
								</ul>
							...
							<li class="green">
								<a href="#">
									<span class="nav-caption">Frutas</span>
									<span class="nav-description">Catálogo</span>
								</a>
								<ul class="wide-dropdown normalAniamtion">
									<li>
							...
							<li class="green">
								<a href="#">
									<span class="nav-caption">Setas</span>
									<span class="nav-description">Catálogo</span>
								</a>
								<ul class="wide-dropdown normalAniamtion">
									<li>
							...
							<li class="green">
								<a href="#">
									<span class="nav-caption">Hierbas</span>
									<span class="nav-description">Catálogo</span>
								</a>
								<ul class="wide-dropdown normalAniamtion">
									<li>
							...
							<li class="green">
								<a href="#">
									<span class="nav-caption">Delicatessen</span>
									<span class="nav-description">Catálogo</span>
								</a>
								<ul class="wide-dropdown normalAniamtion">
									<li>
